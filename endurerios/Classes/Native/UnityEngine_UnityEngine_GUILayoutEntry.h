...
struct  GUILayoutEntry_t7_208  : public Object_t
{
	...
	GUIStyle_t7_207 * ___m_Style_7;
};
struct GUILayoutEntry_t7_208_StaticFields{
	// UnityEngine.Rect UnityEngine.GUILayoutEntry::kDummyRect
	Rect_t7_35  ___kDummyRect_8;
