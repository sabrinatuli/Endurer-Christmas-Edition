...
public class EnemyHealth : MonoBehaviour {
	...
	void Update() {
		...
		if (isBurning) {
			...
			//myRenderer.materials[0].SetFloat("_Cutoff", 1);
		}
	}
	...
	IEnumerator StartSinking() {
		...
		if (waveManager.waveNumber == 10 && waveManager.enemiesAlive == 0)
		{
			MadLevelManager.MadLevelProfile.SetCompleted (MadLevelManager.MadLevel.currentLevelName,true);
			string nextlevel = MadLevelManager.MadLevel.GetNextLevelName();
			MadLevelManager.MadLevelProfile.SetLocked (nextlevel,false);
			ShowAd();
			//Application.LoadLevel ("sceneselect");
		}
		else if (waveManager.waveNumber == 20 && waveManager.enemiesAlive == 0)
		{
			MadLevelManager.MadLevelProfile.SetCompleted (MadLevelManager.MadLevel.currentLevelName,true);
			string nextlevel = MadLevelManager.MadLevel.GetNextLevelName();
			MadLevelManager.MadLevelProfile.SetLocked (nextlevel,false);
		...
		else if (waveManager.waveNumber == 30 && waveManager.enemiesAlive == 0)
		{
			MadLevelManager.MadLevelProfile.SetCompleted (MadLevelManager.MadLevel.currentLevelName,true);
			string nextlevel = MadLevelManager.MadLevel.GetNextLevelName();
			MadLevelManager.MadLevelProfile.SetLocked (nextlevel,false);
		...
		else if (waveManager.waveNumber == 40 && waveManager.enemiesAlive == 0)
		{
			MadLevelManager.MadLevelProfile.SetCompleted (MadLevelManager.MadLevel.currentLevelName,true);
			string nextlevel = MadLevelManager.MadLevel.GetNextLevelName();
			MadLevelManager.MadLevelProfile.SetLocked (nextlevel,false);
		...
		else if (waveManager.waveNumber == 50 && waveManager.enemiesAlive == 0)
		{
			MadLevelManager.MadLevelProfile.SetCompleted (MadLevelManager.MadLevel.currentLevelName,true);
			string nextlevel = MadLevelManager.MadLevel.GetNextLevelName();
			MadLevelManager.MadLevelProfile.SetLocked (nextlevel,false);
		...
		else if (waveManager.waveNumber == 60 && waveManager.enemiesAlive == 0)
		{
			MadLevelManager.MadLevelProfile.SetCompleted (MadLevelManager.MadLevel.currentLevelName,true);
			string nextlevel = MadLevelManager.MadLevel.GetNextLevelName();
			MadLevelManager.MadLevelProfile.SetLocked (nextlevel,false);
		...
		if (waveManager.waveNumber == 70 && waveManager.enemiesAlive == 0)
		{
			MadLevelManager.MadLevelProfile.SetCompleted (MadLevelManager.MadLevel.currentLevelName,true);
			ShowAd();
			//Application.LoadLevel ("sceneselect");
