...
struct  ExtendedKeyUsageExtension_t3_46  : public X509Extension_t3_4
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1_115 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t3_46_StaticFields{
	...
	Dictionary_2_t1_79 * ___U3CU3Ef__switchU24map14_4;
};
