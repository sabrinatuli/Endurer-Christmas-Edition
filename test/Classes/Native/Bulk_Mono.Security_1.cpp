...
struct X509CertificateCollection_t2_34;
...
extern "C" void TlsServerCertificate__ctor_m3_835 (TlsServerCertificate_t3_105 * __this, Context_t3_60 * ___context, ByteU5BU5D_t1_73* ___buffer, const MethodInfo* method)
{
	{
...
extern "C" void TlsServerCertificate_ProcessAsTls1_m3_838 (TlsServerCertificate_t3_105 * __this, const MethodInfo* method)
{
	...
	{
		X509CertificateCollection_t3_10_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(754);
		X509Certificate_t3_0_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(654);
...
IL_0019:
	...
	{
		int32_t L_5 = V_2;
		ByteU5BU5D_t1_73* L_6 = TlsStream_ReadBytes_m3_785(__this, L_5, /*hidden argument*/NULL);
		V_3 = L_6;
...
extern "C" bool TlsServerCertificate_checkCertificateUsage_m3_839 (TlsServerCertificate_t3_105 * __this, X509Certificate_t3_0 * ___cert, const MethodInfo* method)
{
	...
	if (!s_Il2CppMethodIntialized)
	{
		ClientContext_t3_63_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(775);
		KeyUsageExtension_t3_49_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(821);
		ExtendedKeyUsageExtension_t3_46_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(768);
		NetscapeCertTypeExtension_t3_51_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(822);
...
IL_006a:
	{
		...
		NullCheck(L_9);
		X509Extension_t3_4 * L_10 = X509ExtensionCollection_get_Item_m3_27(L_9, _stringLiteral1538, /*hidden argument*/NULL);
		V_4 = L_10;
...
IL_008f:
	{
		...
		NullCheck(L_15);
		X509Extension_t3_4 * L_16 = X509ExtensionCollection_get_Item_m3_27(L_15, _stringLiteral1542, /*hidden argument*/NULL);
		V_4 = L_16;
...
IL_00ca:
	{
		...
		NullCheck(L_25);
		ArrayList_t1_115 * L_26 = ExtendedKeyUsageExtension_get_KeyPurpose_m3_359(L_25, /*hidden argument*/NULL);
		NullCheck(L_26);
		bool L_27 = (bool)VirtFuncInvoker1< bool, Object_t * >::Invoke(32 /* System.Boolean System.Collections.ArrayList::Contains(System.Object) */, L_26, _stringLiteral2235);
		if (L_27)
		{
			goto IL_00f1;
		}
	}
	{
		...
		NullCheck(L_28);
		ArrayList_t1_115 * L_29 = ExtendedKeyUsageExtension_get_KeyPurpose_m3_359(L_28, /*hidden argument*/NULL);
		NullCheck(L_29);
		bool L_30 = (bool)VirtFuncInvoker1< bool, Object_t * >::Invoke(32 /* System.Boolean System.Collections.ArrayList::Contains(System.Object) */, L_29, _stringLiteral2493);
...
IL_0101:
	...
	}
	{
		...
		NullCheck(L_36);
		ArrayList_t1_115 * L_37 = ExtendedKeyUsageExtension_get_KeyPurpose_m3_359(L_36, /*hidden argument*/NULL);
		NullCheck(L_37);
		bool L_38 = (bool)VirtFuncInvoker1< bool, Object_t * >::Invoke(32 /* System.Boolean System.Collections.ArrayList::Contains(System.Object) */, L_37, _stringLiteral2235);
		if (L_38)
		{
			goto IL_012e;
		}
	}
	{
		...
		NullCheck(L_39);
		ArrayList_t1_115 * L_40 = ExtendedKeyUsageExtension_get_KeyPurpose_m3_359(L_39, /*hidden argument*/NULL);
		NullCheck(L_40);
		bool L_41 = (bool)VirtFuncInvoker1< bool, Object_t * >::Invoke(32 /* System.Boolean System.Collections.ArrayList::Contains(System.Object) */, L_40, _stringLiteral2493);
...
IL_0130:
	{
		...
		NullCheck(L_43);
		X509Extension_t3_4 * L_44 = X509ExtensionCollection_get_Item_m3_27(L_43, _stringLiteral2260, /*hidden argument*/NULL);
		V_4 = L_44;
...
extern "C" void TlsServerCertificate_validateCertificates_m3_840 (TlsServerCertificate_t3_105 * __this, X509CertificateCollection_t3_10 * ___certificates, const MethodInfo* method)
{
	...
	if (!s_Il2CppMethodIntialized)
	{
		...
		TlsException_t3_96_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(796);
		...
		X509CertificateCollection_t3_10_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(754);
		X509Chain_t3_42_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(823);
...
IL_008f:
	{
		...
		String_t* L_19 = String_Format_m1_412(NULL /*static, unused*/, _stringLiteral2494, L_18, /*hidden argument*/NULL);
		V_4 = L_19;
		uint8_t L_20 = V_1;
		String_t* L_21 = V_4;
		String_t* L_22 = String_Concat_m1_420(NULL /*static, unused*/, _stringLiteral2495, L_21, /*hidden argument*/NULL);
...
IL_00b4:
	{
		...
		X509Certificate__ctor_m1_3689(L_28, L_27, /*hidden argument*/NULL);
		V_6 = L_28;
		ArrayList_t1_115 * L_29 = (ArrayList_t1_115 *)il2cpp_codegen_object_new (ArrayList_t1_115_il2cpp_TypeInfo_var);
		ArrayList__ctor_m1_1602(L_29, /*hidden argument*/NULL);
		V_7 = L_29;
...
IL_0243:
	{
		...
		Type_t * L_82 = Type_GetTypeFromHandle_m1_902(NULL /*static, unused*/, LoadTypeToken(Int32_t1_3_0_0_0_var), /*hidden argument*/NULL);
		NullCheck(L_81);
	...
	}
	{
		...
		TlsException__ctor_m3_756(L_90, L_89, _stringLiteral2496, /*hidden argument*/NULL);
...
extern "C" bool TlsServerCertificate_checkServerIdentity_m3_841 (TlsServerCertificate_t3_105 * __this, X509Certificate_t3_0 * ___cert, const MethodInfo* method)
{
	...
	{
		ClientContext_t3_63_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(775);
		SubjectAltNameExtension_t3_52_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(824);
		String_t_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(11);
	...
	int32_t V_9 = 0;
	{
		...
		NullCheck(L_5);
		X509Extension_t3_4 * L_6 = X509ExtensionCollection_get_Item_m3_27(L_5, _stringLiteral2259, /*hidden argument*/NULL);
		V_2 = L_6;
	...
	}
	{
		...
		NullCheck(L_10);
		StringU5BU5D_t1_202* L_11 = SubjectAltNameExtension_get_DNSNames_m3_376(L_10, /*hidden argument*/NULL);
		V_5 = L_11;
		V_6 = 0;
		goto IL_0062;
	}
...
IL_0062:
	...
	}
	{
		...
		NullCheck(L_21);
		StringU5BU5D_t1_202* L_22 = SubjectAltNameExtension_get_IPAddresses_m3_377(L_21, /*hidden argument*/NULL);
		V_8 = L_22;
		V_9 = 0;
		goto IL_0099;
	}
...
extern "C" bool TlsServerCertificate_checkDomainName_m3_842 (TlsServerCertificate_t3_105 * __this, String_t* ___subjectName, const MethodInfo* method)
{
	...
	MatchCollection_t2_94 * V_3 = {0};
	{
		...
		Regex__ctor_m2_503(L_2, _stringLiteral2497, /*hidden argument*/NULL);
		V_2 = L_2;
		Regex_t2_91 * L_3 = V_2;
		String_t* L_4 = ___subjectName;
		NullCheck(L_3);
		MatchCollection_t2_94 * L_5 = Regex_Matches_m2_522(L_3, L_4, /*hidden argument*/NULL);
		V_3 = L_5;
		MatchCollection_t2_94 * L_6 = V_3;
		NullCheck(L_6);
	...
	{
		MatchCollection_t2_94 * L_8 = V_3;
		NullCheck(L_8);
		Match_t2_83 * L_9 = (Match_t2_83 *)VirtFuncInvoker1< Match_t2_83 *, int32_t >::Invoke(9 /* System.Text.RegularExpressions.Match System.Text.RegularExpressions.MatchCollection::get_Item(System.Int32) */, L_8, 0);
		NullCheck(L_9);
		bool L_10 = Group_get_Success_m2_472(L_9, /*hidden argument*/NULL);
		if (!L_10)
		{
			goto IL_005f;
		}
	...
	{
		MatchCollection_t2_94 * L_11 = V_3;
		NullCheck(L_11);
		Match_t2_83 * L_12 = (Match_t2_83 *)VirtFuncInvoker1< Match_t2_83 *, int32_t >::Invoke(9 /* System.Text.RegularExpressions.Match System.Text.RegularExpressions.MatchCollection::get_Item(System.Int32) */, L_11, 0);
		NullCheck(L_12);
		GroupCollection_t2_89 * L_13 = (GroupCollection_t2_89 *)VirtFuncInvoker0< GroupCollection_t2_89 * >::Invoke(4 /* System.Text.RegularExpressions.GroupCollection System.Text.RegularExpressions.Match::get_Groups() */, L_12);
		NullCheck(L_13);
		Group_t2_88 * L_14 = GroupCollection_get_Item_m2_476(L_13, 1, /*hidden argument*/NULL);
		NullCheck(L_14);
		String_t* L_15 = Capture_get_Value_m2_457(L_14, /*hidden argument*/NULL);
		NullCheck(L_15);
...
extern "C" bool TlsServerCertificate_Match_m3_843 (Object_t * __this /* static, unused */, String_t* ___hostname, String_t* ___pattern, const MethodInfo* method)
{
	...
	}
	{
		...
		CultureInfo_t1_164 * L_5 = CultureInfo_get_InvariantCulture_m1_1936(NULL /*static, unused*/, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
...
IL_0077:
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(CultureInfo_t1_164_il2cpp_TypeInfo_var);
		CultureInfo_t1_164 * L_30 = CultureInfo_get_InvariantCulture_m1_1936(NULL /*static, unused*/, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
...
IL_00c3:
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(CultureInfo_t1_164_il2cpp_TypeInfo_var);
		CultureInfo_t1_164 * L_48 = CultureInfo_get_InvariantCulture_m1_1936(NULL /*static, unused*/, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
...
extern "C" void TlsServerCertificateRequest__ctor_m3_844 (TlsServerCertificateRequest_t3_106 * __this, Context_t3_60 * ___context, ByteU5BU5D_t1_73* ___buffer, const MethodInfo* method)
{
	{
		Context_t3_60 * L_0 = ___context;
		ByteU5BU5D_t1_73* L_1 = ___buffer;
...
extern "C" void TlsServerCertificateRequest_ProcessAsTls1_m3_847 (TlsServerCertificateRequest_t3_106 * __this, const MethodInfo* method)
{
	...
	if (!s_Il2CppMethodIntialized)
	{
		ClientCertificateTypeU5BU5D_t3_97_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(825);
		ASN1_t3_2_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(647);
...
IL_002c:
	...
	}
	{
		...
		ByteU5BU5D_t1_73* L_10 = TlsStream_ReadBytes_m3_785(__this, L_9, /*hidden argument*/NULL);
...
IL_0068:
	{
		...
		NullCheck(L_16);
		ByteU5BU5D_t1_73* L_17 = ASN1_get_Value_m3_4(L_16, /*hidden argument*/NULL);
		...
		Encoding_t1_222 * L_21 = Encoding_get_UTF8_m1_4309(NULL /*static, unused*/, /*hidden argument*/NULL);
		ASN1_t3_2 * L_22 = V_4;
		NullCheck(L_22);
		ASN1_t3_2 * L_23 = ASN1_get_Item_m3_6(L_22, 1, /*hidden argument*/NULL);
		NullCheck(L_23);
		ByteU5BU5D_t1_73* L_24 = ASN1_get_Value_m3_4(L_23, /*hidden argument*/NULL);
		NullCheck(L_21);
...
extern "C" void TlsServerFinished__ctor_m3_848 (TlsServerFinished_t3_107 * __this, Context_t3_60 * ___context, ByteU5BU5D_t1_73* ___buffer, const MethodInfo* method)
{
	{
		Context_t3_60 * L_0 = ___context;
		ByteU5BU5D_t1_73* L_1 = ___buffer;
...
extern "C" void TlsServerFinished__cctor_m3_849 (Object_t * __this /* static, unused */, const MethodInfo* method)
{
	...
	if (!s_Il2CppMethodIntialized)
	{
		...
		TlsServerFinished_t3_107_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(795);
		U3CPrivateImplementationDetailsU3E_t3_121____U24U24fieldU2D22_14_FieldInfo_var = il2cpp_codegen_field_info_from_index(744, 14);
		s_Il2CppMethodIntialized = true;
	}
	{
		ByteU5BU5D_t1_73* L_0 = ((ByteU5BU5D_t1_73*)SZArrayNew(ByteU5BU5D_t1_73_il2cpp_TypeInfo_var, 4));
		RuntimeHelpers_InitializeArray_m1_1000(NULL /*static, unused*/, (Array_t *)(Array_t *)L_0, LoadFieldToken(U3CPrivateImplementationDetailsU3E_t3_121____U24U24fieldU2D22_14_FieldInfo_var), /*hidden argument*/NULL);
...
extern "C" void TlsServerFinished_ProcessAsSsl3_m3_851 (TlsServerFinished_t3_107 * __this, const MethodInfo* method)
{
	...
	if (!s_Il2CppMethodIntialized)
	{
		SslHandshakeHash_t3_93_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(819);
		TlsServerFinished_t3_107_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(795);
		CipherSuite_t3_59_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(774);
		TlsException_t3_96_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(796);
	...
	ByteU5BU5D_t1_73* V_3 = {0};
	{
		Context_t3_60 * L_0 = HandshakeMessage_get_Context_m3_801(__this, /*hidden argument*/NULL);
		NullCheck(L_0);
		ByteU5BU5D_t1_73* L_1 = Context_get_MasterSecret_m3_528(L_0, /*hidden argument*/NULL);
		...
		NullCheck(L_4);
		ByteU5BU5D_t1_73* L_5 = TlsStream_ToArray_m3_792(L_4, /*hidden argument*/NULL);
		V_1 = L_5;
		...
		ByteU5BU5D_t1_73* L_11 = ((TlsServerFinished_t3_107_StaticFields*)TlsServerFinished_t3_107_il2cpp_TypeInfo_var->static_fields)->___Ssl3Marker_9;
		ByteU5BU5D_t1_73* L_12 = ((TlsServerFinished_t3_107_StaticFields*)TlsServerFinished_t3_107_il2cpp_TypeInfo_var->static_fields)->___Ssl3Marker_9;
		NullCheck(L_12);
		ByteU5BU5D_t1_73* L_13 = ((TlsServerFinished_t3_107_StaticFields*)TlsServerFinished_t3_107_il2cpp_TypeInfo_var->static_fields)->___Ssl3Marker_9;
		NullCheck(L_10);
		...
		ByteU5BU5D_t1_73* L_15 = ((CipherSuite_t3_59_StaticFields*)CipherSuite_t3_59_il2cpp_TypeInfo_var->static_fields)->___EmptyArray_0;
		NullCheck(L_14);
		...
		ByteU5BU5D_t1_73* L_17 = TlsStream_ReadBytes_m3_785(__this, (((int32_t)((int32_t)L_16))), /*hidden argument*/NULL);
		V_2 = L_17;
	...
	{
		TlsException_t3_96 * L_23 = (TlsException_t3_96 *)il2cpp_codegen_object_new (TlsException_t3_96_il2cpp_TypeInfo_var);
		TlsException__ctor_m3_756(L_23, ((int32_t)71), _stringLiteral2498, /*hidden argument*/NULL);
		il2cpp_codegen_raise_exception((Il2CppCodeGenException*)L_23);
	}
...
extern "C" void TlsServerFinished_ProcessAsTls1_m3_852 (TlsServerFinished_t3_107 * __this, const MethodInfo* method)
{
	...
	if (!s_Il2CppMethodIntialized)
	{
		MD5SHA1_t3_54_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(812);
		TlsException_t3_96_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(796);
	...
	ByteU5BU5D_t1_73* V_4 = {0};
	{
		...
		ByteU5BU5D_t1_73* L_1 = TlsStream_ReadBytes_m3_785(__this, (((int32_t)((int32_t)L_0))), /*hidden argument*/NULL);
		V_0 = L_1;
		...
		NullCheck(L_8);
		NullCheck(L_6);
		ByteU5BU5D_t1_73* L_9 = HashAlgorithm_ComputeHash_m1_3827(L_6, L_7, 0, (((int32_t)((int32_t)(((Array_t *)L_8)->max_length)))), /*hidden argument*/NULL);
		V_3 = L_9;
		...
		NullCheck(L_13);
		ByteU5BU5D_t1_73* L_14 = Context_get_MasterSecret_m3_528(L_13, /*hidden argument*/NULL);
		ByteU5BU5D_t1_73* L_15 = V_3;
		NullCheck(L_12);
		ByteU5BU5D_t1_73* L_16 = CipherSuite_PRF_m3_428(L_12, L_14, _stringLiteral2499, L_15, ((int32_t)12), /*hidden argument*/NULL);
		V_4 = L_16;
	...
	}
	{
		...
		TlsException__ctor_m3_751(L_20, _stringLiteral2498, /*hidden argument*/NULL);
...
extern "C" void TlsServerHello__ctor_m3_853 (TlsServerHello_t3_108 * __this, Context_t3_60 * ___context, ByteU5BU5D_t1_73* ___buffer, const MethodInfo* method)
{
	{
		Context_t3_60 * L_0 = ___context;
		ByteU5BU5D_t1_73* L_1 = ___buffer;
...
extern "C" void TlsServerHello_Update_m3_854 (TlsServerHello_t3_108 * __this, const MethodInfo* method)
{
	...
	ByteU5BU5D_t1_73* V_4 = {0};
	{
		...
		Context_t3_60 * L_10 = HandshakeMessage_get_Context_m3_801(__this, /*hidden argument*/NULL);
		NullCheck(L_10);
		ByteU5BU5D_t1_73* L_11 = Context_get_ClientRandom_m3_520(L_10, /*hidden argument*/NULL);
		NullCheck(L_11);
		...
		NullCheck(L_12);
		ByteU5BU5D_t1_73* L_13 = Context_get_ServerRandom_m3_522(L_12, /*hidden argument*/NULL);
		NullCheck(L_13);
		...
		NullCheck(L_17);
		ByteU5BU5D_t1_73* L_18 = Context_get_ClientRandom_m3_520(L_17, /*hidden argument*/NULL);
		ByteU5BU5D_t1_73* L_19 = V_3;
		int32_t L_20 = V_0;
		Buffer_BlockCopy_m1_4639(NULL /*static, unused*/, (Array_t *)(Array_t *)L_18, 0, (Array_t *)(Array_t *)L_19, 0, L_20, /*hidden argument*/NULL);
		Context_t3_60 * L_21 = HandshakeMessage_get_Context_m3_801(__this, /*hidden argument*/NULL);
		NullCheck(L_21);
		ByteU5BU5D_t1_73* L_22 = Context_get_ServerRandom_m3_522(L_21, /*hidden argument*/NULL);
		ByteU5BU5D_t1_73* L_23 = V_3;
		int32_t L_24 = V_0;
		int32_t L_25 = V_1;
		Buffer_BlockCopy_m1_4639(NULL /*static, unused*/, (Array_t *)(Array_t *)L_22, 0, (Array_t *)(Array_t *)L_23, L_24, L_25, /*hidden argument*/NULL);
		...
		NullCheck(L_29);
		ByteU5BU5D_t1_73* L_30 = Context_get_ServerRandom_m3_522(L_29, /*hidden argument*/NULL);
		ByteU5BU5D_t1_73* L_31 = V_4;
		int32_t L_32 = V_1;
		Buffer_BlockCopy_m1_4639(NULL /*static, unused*/, (Array_t *)(Array_t *)L_30, 0, (Array_t *)(Array_t *)L_31, 0, L_32, /*hidden argument*/NULL);
		Context_t3_60 * L_33 = HandshakeMessage_get_Context_m3_801(__this, /*hidden argument*/NULL);
		NullCheck(L_33);
		ByteU5BU5D_t1_73* L_34 = Context_get_ClientRandom_m3_520(L_33, /*hidden argument*/NULL);
		ByteU5BU5D_t1_73* L_35 = V_4;
		int32_t L_36 = V_1;
		int32_t L_37 = V_0;
		Buffer_BlockCopy_m1_4639(NULL /*static, unused*/, (Array_t *)(Array_t *)L_34, 0, (Array_t *)(Array_t *)L_35, L_36, L_37, /*hidden argument*/NULL);
...
extern "C" void TlsServerHello_ProcessAsTls1_m3_856 (TlsServerHello_t3_108 * __this, const MethodInfo* method)
{
	...
	if (!s_Il2CppMethodIntialized)
	{
		ClientSessionCache_t3_68_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(798);
		TlsException_t3_96_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(796);
	...
	int16_t V_1 = 0;
	{
		...
		ByteU5BU5D_t1_73* L_1 = TlsStream_ReadBytes_m3_785(__this, ((int32_t)32), /*hidden argument*/NULL);
	...
	{
		int32_t L_4 = V_0;
		ByteU5BU5D_t1_73* L_5 = TlsStream_ReadBytes_m3_785(__this, L_4, /*hidden argument*/NULL);
		...
		Context_t3_60 * L_12 = HandshakeMessage_get_Context_m3_801(__this, /*hidden argument*/NULL);
		NullCheck(L_12);
		ByteU5BU5D_t1_73* L_13 = Context_get_SessionId_m3_499(L_12, /*hidden argument*/NULL);
...
IL_0082:
	...
	}
	{
		...
		TlsException__ctor_m3_756(L_21, ((int32_t)71), _stringLiteral2500, /*hidden argument*/NULL);
...
IL_0079:
	{
		...
		TlsException__ctor_m3_756(L_17, ((int32_t)70), _stringLiteral2446, /*hidden argument*/NULL);
...
extern "C" void TlsServerHelloDone__ctor_m3_858 (TlsServerHelloDone_t3_109 * __this, Context_t3_60 * ___context, ByteU5BU5D_t1_73* ___buffer, const MethodInfo* method)
{
	{
		Context_t3_60 * L_0 = ___context;
		ByteU5BU5D_t1_73* L_1 = ___buffer;
...
extern "C" void TlsServerKeyExchange__ctor_m3_861 (TlsServerKeyExchange_t3_110 * __this, Context_t3_60 * ___context, ByteU5BU5D_t1_73* ___buffer, const MethodInfo* method)
{
	{
		Context_t3_60 * L_0 = ___context;
		ByteU5BU5D_t1_73* L_1 = ___buffer;
...
extern "C" void TlsServerKeyExchange_ProcessAsTls1_m3_864 (TlsServerKeyExchange_t3_110 * __this, const MethodInfo* method)
{
	...
	RSAParameters_t1_589  V_0 = {0};
	{
		...
		ByteU5BU5D_t1_73* L_3 = TlsStream_ReadBytes_m3_785(__this, L_2, /*hidden argument*/NULL);
		...
		ByteU5BU5D_t1_73* L_8 = TlsStream_ReadBytes_m3_785(__this, L_7, /*hidden argument*/NULL);
...
extern "C" void TlsServerKeyExchange_verifySignature_m3_865 (TlsServerKeyExchange_t3_110 * __this, const MethodInfo* method)
{
	...
	{
		MD5SHA1_t3_54_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(812);
		TlsStream_t3_73_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(776);
		TlsException_t3_96_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(796);
	...
	bool V_3 = false;
	{
		...
		Context_t3_60 * L_7 = HandshakeMessage_get_Context_m3_801(__this, /*hidden argument*/NULL);
		NullCheck(L_7);
		ByteU5BU5D_t1_73* L_8 = Context_get_RandomCS_m3_524(L_7, /*hidden argument*/NULL);
		NullCheck(L_6);
		TlsStream_Write_m3_790(L_6, L_8, /*hidden argument*/NULL);
		TlsStream_t3_73 * L_9 = V_2;
		ByteU5BU5D_t1_73* L_10 = TlsStream_ToArray_m3_792(__this, /*hidden argument*/NULL);
		int32_t L_11 = V_1;
		NullCheck(L_9);
		...
		NullCheck(L_13);
		ByteU5BU5D_t1_73* L_14 = TlsStream_ToArray_m3_792(L_13, /*hidden argument*/NULL);
		NullCheck(L_12);
		HashAlgorithm_ComputeHash_m1_3826(L_12, L_14, /*hidden argument*/NULL);
		...
		NullCheck(L_18);
		RSA_t1_120 * L_19 = TlsServerSettings_get_CertificateRSA_m3_763(L_18, /*hidden argument*/NULL);
	...
	{
		TlsException_t3_96 * L_23 = (TlsException_t3_96 *)il2cpp_codegen_object_new (TlsException_t3_96_il2cpp_TypeInfo_var);
		TlsException__ctor_m3_756(L_23, ((int32_t)50), _stringLiteral2501, /*hidden argument*/NULL);
		il2cpp_codegen_raise_exception((Il2CppCodeGenException*)L_23);
	}
...
extern "C" Object_t * PrimalityTest_BeginInvoke_m3_868 (PrimalityTest_t3_111 * __this, BigInteger_t3_18 * ___bi, int32_t ___confidence, AsyncCallback_t1_28 * ___callback, Object_t * ___object, const MethodInfo* method)
{
	...
	if (!s_Il2CppMethodIntialized)
	{
		ConfidenceFactor_t3_20_il2cpp_TypeInfo_var = il2cpp_codegen_type_info_from_index(827);
		s_Il2CppMethodIntialized = true;
	}
	void *__d_args[3] = {0};
	__d_args[0] = ___bi;
...
extern "C" bool CertificateValidationCallback_Invoke_m3_871 (CertificateValidationCallback_t3_90 * __this, X509Certificate_t1_542 * ___certificate, Int32U5BU5D_t1_162* ___certificateErrors, const MethodInfo* method)
{
	if(__this->___prev_9 != NULL)
	{
...
extern "C" bool pinvoke_delegate_wrapper_CertificateValidationCallback_t3_90(Il2CppObject* delegate, X509Certificate_t1_542 * ___certificate, Int32U5BU5D_t1_162* ___certificateErrors)
{
...
extern "C" Object_t * CertificateValidationCallback_BeginInvoke_m3_872 (CertificateValidationCallback_t3_90 * __this, X509Certificate_t1_542 * ___certificate, Int32U5BU5D_t1_162* ___certificateErrors, AsyncCallback_t1_28 * ___callback, Object_t * ___object, const MethodInfo* method)
{
	void *__d_args[3] = {0};
...
extern "C" X509Certificate_t1_542 * CertificateSelectionCallback_Invoke_m3_879 (CertificateSelectionCallback_t3_78 * __this, X509CertificateCollection_t2_34 * ___clientCertificates, X509Certificate_t1_542 * ___serverCertificate, String_t* ___targetHost, X509CertificateCollection_t2_34 * ___serverRequestedCertificates, const MethodInfo* method)
{
	if(__this->___prev_9 != NULL)
	{
	...
	if (__this->___m_target_2 != NULL && ___methodIsStatic)
	{
		typedef X509Certificate_t1_542 * (*FunctionPointerType) (Object_t *, Object_t * __this, X509CertificateCollection_t2_34 * ___clientCertificates, X509Certificate_t1_542 * ___serverCertificate, String_t* ___targetHost, X509CertificateCollection_t2_34 * ___serverRequestedCertificates, const MethodInfo* method);
	...
	{
		typedef X509Certificate_t1_542 * (*FunctionPointerType) (Object_t * __this, X509CertificateCollection_t2_34 * ___clientCertificates, X509Certificate_t1_542 * ___serverCertificate, String_t* ___targetHost, X509CertificateCollection_t2_34 * ___serverRequestedCertificates, const MethodInfo* method);
	...
	{
		typedef X509Certificate_t1_542 * (*FunctionPointerType) (Object_t * __this, X509Certificate_t1_542 * ___serverCertificate, String_t* ___targetHost, X509CertificateCollection_t2_34 * ___serverRequestedCertificates, const MethodInfo* method);
...
extern "C" X509Certificate_t1_542 * pinvoke_delegate_wrapper_CertificateSelectionCallback_t3_78(Il2CppObject* delegate, X509CertificateCollection_t2_34 * ___clientCertificates, X509Certificate_t1_542 * ___serverCertificate, String_t* ___targetHost, X509CertificateCollection_t2_34 * ___serverRequestedCertificates)
{
	// Marshaling of parameter '___clientCertificates' to native representation
	X509CertificateCollection_t2_34 * ____clientCertificates_marshaled = { 0 };
...
extern "C" Object_t * CertificateSelectionCallback_BeginInvoke_m3_880 (CertificateSelectionCallback_t3_78 * __this, X509CertificateCollection_t2_34 * ___clientCertificates, X509Certificate_t1_542 * ___serverCertificate, String_t* ___targetHost, X509CertificateCollection_t2_34 * ___serverRequestedCertificates, AsyncCallback_t1_28 * ___callback, Object_t * ___object, const MethodInfo* method)
{
	void *__d_args[5] = {0};
...
extern "C" X509Certificate_t1_542 * CertificateSelectionCallback_EndInvoke_m3_881 (CertificateSelectionCallback_t3_78 * __this, Object_t * ___result, const MethodInfo* method)
{
	Il2CppObject *__result = il2cpp_delegate_end_invoke((Il2CppAsyncResult*) ___result, 0);
...
extern "C" AsymmetricAlgorithm_t1_544 * PrivateKeySelectionCallback_Invoke_m3_883 (PrivateKeySelectionCallback_t3_79 * __this, X509Certificate_t1_542 * ___certificate, String_t* ___targetHost, const MethodInfo* method)
{
	if(__this->___prev_9 != NULL)
	{
...
extern "C" AsymmetricAlgorithm_t1_544 * pinvoke_delegate_wrapper_PrivateKeySelectionCallback_t3_79(Il2CppObject* delegate, X509Certificate_t1_542 * ___certificate, String_t* ___targetHost)
{
	// Marshaling of parameter '___certificate' to native representation
	X509Certificate_t1_542 * ____certificate_marshaled = { 0 };
	il2cpp_codegen_raise_exception((Il2CppCodeGenException*)il2cpp_codegen_get_not_supported_exception("Cannot marshal type 'System.Security.Cryptography.X509Certificates.X509Certificate'."));
...
extern "C" Object_t * PrivateKeySelectionCallback_BeginInvoke_m3_884 (PrivateKeySelectionCallback_t3_79 * __this, X509Certificate_t1_542 * ___certificate, String_t* ___targetHost, AsyncCallback_t1_28 * ___callback, Object_t * ___object, const MethodInfo* method)
{
	void *__d_args[3] = {0};
	__d_args[0] = ___certificate;
...
extern "C" AsymmetricAlgorithm_t1_544 * PrivateKeySelectionCallback_EndInvoke_m3_885 (PrivateKeySelectionCallback_t3_79 * __this, Object_t * ___result, const MethodInfo* method)
{
	Il2CppObject *__result = il2cpp_delegate_end_invoke((Il2CppAsyncResult*) ___result, 0);
