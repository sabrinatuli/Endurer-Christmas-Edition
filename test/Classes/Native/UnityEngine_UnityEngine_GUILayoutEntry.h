...
struct  GUILayoutEntry_t5_194  : public Object_t
{
	...
	GUIStyle_t5_193 * ___m_Style_7;
};
struct GUILayoutEntry_t5_194_StaticFields{
	// UnityEngine.Rect UnityEngine.GUILayoutEntry::kDummyRect
	Rect_t5_33  ___kDummyRect_8;
